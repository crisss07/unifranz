...
<nav class="navbar navbar-expand-lg menu">
  ...
  <div class="collapse navbar-collapse montserrat-medium justify-content-end" style="font-size:14px;" id="navbarNav">
	...
	<!-- Modal -->
    <div class="modal" id="recuperarContrasenaModal" tabindex="-1" role="dialog">
	      ...
	      <div class="row">
	        ...
	        <div class="panel__left col-12 col-lg-7 py-4 px-4">
	          <div class="panel__left-title text-center">  
	            ...
	            <p class="texto-registro">Bienvenido, en caso que no tengas una cuenta puedes registrarte si eres ex alumno de Unifranz</p>
	          </div>
	          ...
	          <div class="panel__left-footer text-center">
	            <a href="#" class="color-link" data-toggle="modal" data-target="#recuperarContrasenaModal">¿Olvidaste tu contraseña?</a><br>
